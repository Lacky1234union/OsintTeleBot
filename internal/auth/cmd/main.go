...
import (
	...
	"github.com/russunion/OsintTeleBot/internal/auth/internal/app"
	"github.com/russunion/OsintTeleBot/internal/auth/internal/domain"
	authhttp "github.com/russunion/OsintTeleBot/internal/auth/internal/interfaces/http"
)
...
func main() {
	...
	authHandler := authhttp.NewAuthHandler(userService, tokenService)
